...
soup = BeautifulSoup(open("C:\\SpaceY\\Puzzle archive\\March 1, 2018 Daily Mini Crossword Puzzle - The New York Times.html"), 'html.parser')
w=8
#This w is here because they changed the structure of the puzzle page in april and order of the necessary inputs differ in the html file.
